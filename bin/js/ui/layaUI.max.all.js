...
(function (ui) {
    var test_toastUI = /** @class */ (function (_super) {
        __extends(test_toastUI, _super);
        function test_toastUI() {
            return _super.call(this) || this;
        }
        test_toastUI.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.createView(ui.test_toastUI.uiView);
        };
        test_toastUI.uiView = { "type": "View", "props": { "width": 600, "height": 400 }, "child": [{ "type": "Label", "props": { "y": 185, "x": 255, "text": "已通关", "fontSize": 30, "color": "#ff0000" } }] };
        return test_toastUI;
    }(View));
    ui.test_toastUI = test_toastUI;
})(ui || (ui = {}));
