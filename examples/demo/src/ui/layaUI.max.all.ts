...
module ui {
    export class test_rankUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{"width":600,"height":400},"child":[{"type":"Image","props":{"y":57,"x":63,"skin":"comp/image.png"}},{"type":"Label","props":{"y":16,"x":203,"text":"label","name":"nickname","fontSize":50,"color":"#333333"}},{"type":"List","props":{"y":62,"x":232,"width":248,"name":"rankList","height":256},"child":[{"type":"Box","props":{"width":300,"name":"render"},"child":[{"type":"Label","props":{"y":14,"x":14,"text":"label","name":"score"}},{"type":"Label","props":{"y":12,"x":70,"text":"label","name":"nickname"}},{"type":"Image","props":{"y":-4,"x":135,"width":50,"name":"avatarUrl","height":50}}]}]}]};
        constructor(){ super()}
        createChildren():void {
